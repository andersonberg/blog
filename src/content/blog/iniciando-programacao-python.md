...
category: []
description: >-
  Neste blog vou apresentar o que eu aprendi de Python durante mais de três anos
  e minhas experiências diárias com a linguagem. Vou começar do início,
  mostrando para aqueles que estão iniciando a como programar nesta poderosa
  linguagem.
...
![Interpretador Python no Shell do Linux](/images/posts/python-linux.png "Interpretador Python no Shell do Linux")
...
![Chamando o interpretador Python na linha de comando](/images/posts/python-cmd1.png)
...
![IDLE Python](/images/posts/idle-python.png)
