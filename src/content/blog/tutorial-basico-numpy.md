...
description: >-
  NumPy é um pacote de Python que suporta operações com vetores e matrizes e é
  essencial para a computação científica com Python. O NumPy é baseado em C,
  portanto tem um desempenho superior se comparado às operações com vetores
  originais do Python. Neste post eu quero mostrar uma introdução básica ao
  NumPy para os iniciantes.
image: /images/posts/matriz.jpg
slug: tutorial-basico-numpy
aliases:
  - /blog/tutorial-basico-numpy/
---
...
![Matriz numpy](/images/posts/matriz.jpg "Matriz numpy Fonte: SciPy 2011 - Jonathan Rocher")
